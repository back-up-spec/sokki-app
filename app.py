...
def main():
    ...
    # ========================================
        ...
        if st.session_state.current_q_index < total:
            ...
            # スコアの発表
            st.success(f"### 🎯 総合スコア： {st.session_state.score_history[-1]:,} 点")
